...
from recipients.views import RecipientTemplateView
...
urlpatterns = [
    ...
    path('status/', cache_page(60)(MailingStatusListView.as_view()), name='status_list'),
    path('status/<int:pk>/', MailingStatusDetailView.as_view(), name='status_view'),
]